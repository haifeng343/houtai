    ...
    <div class="storeAddFrame">
      ...
      <el-form label-width="100px">
        <el-form-item label="门店名称:" prop="storeName">
          <el-input v-model="storeName" placeholder="请输入门店名称" disabled></el-input>
        </el-form-item>
        <!-- <el-form-item label="门店品类:">
          <el-input v-model="category" placeholder="请选择门店品类" disabled></el-input>
          <i
            :class="{'el-icon-arrow-down':!categoryVisible,'el-icon-arrow-up':categoryVisible}"
            class="arrowLocation"
            @click="CategoryIsShow"
          ></i>
          <div v-if="categoryVisible==true">
            <label v-if="totalCategoryList.length<=0">暂无门店品类</label>
            <el-checkbox-group
              v-else
            ...
            >
              <el-checkbox
                v-for="x in totalCategoryList"
                :label="x.CategoryId"
                :key="x.CategoryId"
              >{{x.CategoryName}}</el-checkbox>
            </el-checkbox-group>
          </div>
        </el-form-item> -->
        <el-form-item label="门店品类:">
        ...
        <el-form-item label="营业执照:">
          ...
          <lable v-else>暂无图片</lable>
        </el-form-item>
        <el-form-item label="营业状态:">
          <el-select v-model="businessStatus" placeholder="请选择" disabled>
            <el-option
        ...
        <el-form-item label="负责人:" prop="leader">
          <el-input v-model="leader" placeholder="请输入负责人" style="width:215px;" disabled></el-input>
        </el-form-item>
        <el-form-item label="负责人电话:">
          <el-input v-model="leaderMobile" placeholder="请输入负责人电话" style="width:215px;" disabled></el-input>
        </el-form-item>
      </el-form>
    ...
    <div class="storeAddFrame">
      ...
      <el-form :inline="true" class="demo-form-inline">
        <el-form-item label="省份:" label-width="100px" prop="province">
          <el-select v-model="province" placeholder="请选择省份" @change="choseProvince" disabled>
            <el-option
        ...
        <el-form-item label="区/县:" prop="province" @change="choseDistrict">
          <el-select v-model="district" placeholder="请选择区/县" disabled>
      ...
      <el-form label-width="100px">
        ...
        <el-form-item label="门店地址:" prop="address">
          <el-input v-model="address" placeholder="请输入门店地址" disabled></el-input>
        </el-form-item>
  ...
  methods: {
    ...
    locationChange(data) {
      if (data != null) {
        ...
        this.locationAddress = data.lng + "," + data.lat;
      }
    },
    //是否显示门店平列选择列表
    CategoryIsShow() {
    ...
    _getSellerStoreCategoryList() {
      ...
      return GetSellerStoreCategoryList(par,190).then(res => {
    ...
    _getTradingAreaList() {
      ...
      return GetTradingAreaList(par,190).then(res => {
    ...
    _getSellerStoreDetails() {
      ...
      return GetSellerStoreDetails(par,190).then(res => {
