    ...
    <div class="storeAddFrame">
      ...
      <el-form label-width="100px">
        ...
        <el-form-item label="定位地址:">
          <baiduMap v-on:location="locationChange"></baiduMap>
        </el-form-item>
      </el-form>
    </div>
...
export default {
  ...
  created() {
    ...
    this._getSellerStoreCategoryList();
    this.getCityData();
  },
  watch: {
  ...
  methods: {
    ...
    addSellerOk() {
      this._addSellerStore().then(val => {
        ...
        this.businessTimeList = [];
        this.leader = "";
        this.leaderMobile = "";
        this.coverImg = "";
        this.coverImgShowUrl = "";
        this.province = "";
        this.city = "";
        this.province = "";
        this.district = "";
        ...
        this.latitude = 0;
        this.tradingArea = "";
        this.selectTradingAreaList = [];
        this.tradingAreaVisible = false;
    ...
    _getSellerStoreCategoryList() {
      ...
      return GetSellerStoreCategoryList(par,158).then(res => {
    ...
    _getTradingAreaList() {
      ...
      return GetTradingAreaList(par,158).then(res => {
