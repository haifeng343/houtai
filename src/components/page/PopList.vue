  ...
  <div>
    <div>
      <el-form :inline="true" class="demo-form-inline">
        <el-form-item label="弹窗名称:">
          <el-input v-model="Popname" placeholder="请输入弹窗名称"></el-input>
        </el-form-item>
    ...
    <div>
      <el-table :data="paymentListTable" border ref="multipleTable">
        ...
        <el-table-column align="center" width="120" label="弹窗名称">
          <template slot-scope="scope">
            <el-button type="text" @click="showPopName(scope.row)">{{scope.row.Name}}</el-button>
          </template>
        </el-table-column>
        <el-table-column align="center" width="120" label="分组标识">
          <template slot-scope="scope">
            <el-button
              type="text"
        ...
        <el-table-column align="center" width="120" label="展示图片">
          <template slot-scope="scope">
            <el-button type="text" @click="showImg(scope.row)">预览图片</el-button>
          </template>
        </el-table-column>
        ...
        <el-table-column align="center" label="弹窗规则">
          <template slot-scope="scope">
        ...
        <el-table-column align="center" width="120" label="定时关闭">
          <template slot-scope="scope">
            <el-button
              type="text"
        ...
        <el-table-column align="center" width="240" label="排序值">
          <template slot-scope="scope">
            <el-button type="text" @click="showSort(scope.row)">{{scope.row.OrderIndex}}</el-button>
          </template>
        </el-table-column>
        <!-- <el-table-column align="center" width="160" label="有效时间">
          <template slot-scope="scope">
            <el-button type="text" @click="showVlideTime(scope.row)">{{scope.row.CreateTime}}</el-button>
          </template>
        </el-table-column>-->
        <el-table-column align="center" width="160" label="是否有效">
          <template slot-scope="scope">
            <el-switch
        ...
        <el-table-column prop="CreateTime" width="240" align="center" label="创建时间"></el-table-column>
    ...
    <!-- 编辑弹窗名称 -->
    <el-dialog title=" 编辑弹窗名称" :visible.sync="editPopNameVisible" width="800px">
      <el-form
        ref="editPopNameForm"
      ...
      >
        <el-form-item label="弹窗名称:" prop="Name">
          <el-input v-model="editPopNameForm.Name" placeholder="请输入弹窗名称"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
    ...
    <!-- 编辑点击行为 -->
    <el-dialog title=" 编辑点击行为-" :visible.sync="editPopBehaviorVisible" width="800px">
      <el-form
      ...
      >
        <el-form-item label="点击前执行参数:">
          <el-select
            v-model="editPopBehaviorForm.ExecuteParams"
            placeholder="请选择点击前执行参数"
            class="w585"
          >
            <el-option
              v-for="item in ExecuteParamsForm"
        ...
        <el-form-item label="点击类型:" prop="ActionType">
          <el-select v-model="editPopBehaviorForm.ActionType" placeholder="请选择点击行为" class="w585">
            <el-option
              v-for="item in ActionTypeForm"
              :label="item.name"
              :key="item.Id"
        ...
        <el-form-item label="点击参数:">
          <el-input v-model="editPopBehaviorForm.ActionParams" placeholder="请输入点击参数"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
    ...
    <!-- 编辑弹窗规则 -->
    <el-dialog title=" 编辑弹窗规则-" :visible.sync="editPopFrequencyVisible" width="800px">
      <el-form
      ...
      >
        <el-form-item label="设备标识:" prop="PopCheckType">
          <el-select v-model="editPopFrequencyForm.PopCheckType" placeholder="请选择设备标识" class="w585">
            <el-option
              v-for="item in PopCheckTypeForm"
              :label="item.name"
              :key="item.Id"
        ...
        <el-form-item label="日期类型:" prop="PopCircleType">
          <el-select
            v-model="editPopFrequencyForm.PopCircleType"
            placeholder="请选择日期类型"
            class="w585"
          >
            <el-option
        ...
        <el-form-item label="单期次数:" prop="PopCircleCount">
          <el-input v-model="editPopFrequencyForm.PopCircleCount" placeholder="-1表示不限次数"></el-input>
        </el-form-item>
        <el-form-item label="总次数:" prop="PopTotalCount">
          <el-input v-model="editPopFrequencyForm.PopTotalCount" placeholder="-1表示不限总次数"></el-input>
        </el-form-item>
        <el-form-item label="开始时间:">
          <div class="flex-start">
            <div>：</div>
            <el-date-picker
              v-model="editPopFrequencyForm.StartTime"
              class="w160"
              type="datetime"
              placeholder="选择开始时间"
            ></el-date-picker>
            <div class="ml30">结束时间：</div>
            <el-date-picker
              v-model="editPopFrequencyForm.EndTime"
              class="w160"
              type="datetime"
              placeholder="选择结束时间"
            ></el-date-picker>
        ...
        <el-form-item label="任务标识:">
          <el-select v-model="editPopFrequencyForm.ReceiveToken" placeholder="请选择任务标识" class="w585">
            <el-option
              v-for="item in taskForm"
              :label="item.Name"
              :key="item.ReceiveToken"
    ...
    <!-- 编辑定时关闭 -->
    <el-dialog title=" 编辑定时关闭-" :visible.sync="editPopTimingVisible" width="800px">
      <el-form
      ...
      >
        <el-form-item label="定时关闭(ms):" prop="CloseTime">
          <el-input v-model="editPopTimingForm.CloseTime" placeholder="-1表示没有定时关闭"></el-input>
        </el-form-item>
        <el-form-item label="显示关闭按钮:" prop="ShowClose">
          <el-radio-group v-model="editPopTimingForm.ShowClose">
            <el-radio :label="1">显示</el-radio>
            <el-radio :label="2" :disabled="editPopTimingForm.CloseTime==-1">关闭</el-radio>
          </el-radio-group>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
    ...
    <!-- 编辑有效时间 -->
    <el-dialog title=" 编辑有效时间" :visible.sync="editPopVlideTimeVisible" width="800px">
      <el-form
      ...
      >
        <el-form-item label="有效时间:">
          <div class="flex-start">
            <div>开始时间：</div>
            <el-date-picker
              v-model="editPopVlideTimeForm.begin"
              class="w160"
              type="datetime"
              placeholder="选择开始时间"
            ></el-date-picker>
  ...
  methods: {
    ...
    _popTaskList() {
      ...
      popTaskList(par, 243).then(res => {
        ...
        this.taskForm.unshift({ Name: "无", ReceiveToken: "" });
      });
    },
    //搜索
    paymentListSearch() {
